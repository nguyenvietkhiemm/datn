 ...
 * tags:
 *   - name: Flashcards
 *     description: API quản lý flashcard và deck
 */
 ...
 */
flashcardRouter.get("/decks", Authentication.AuthenticateToken, FlashcardDeckController.getAll);

/**
 * @swagger
 * /flashcards/decks/{id}:
 *   get:
 *     summary: Lấy thông tin chi tiết của một deck theo ID (yêu cầu đăng nhập)
 *     tags: [Flashcards]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *         description: Không tìm thấy deck
 */
flashcardRouter.post("/decks/add/:id", Authentication.AuthenticateToken, FlashcardController.add);
 ...
 *         description: Không tìm thấy deck
 */
flashcardRouter.delete("/decks/delete/:id", Authentication.AuthenticateToken, FlashcardDeckController.delete);
 ...
 */
flashcardRouter.put("/update/:id", Authentication.AuthenticateToken, FlashcardController.update);
 ...
 *         description: Không tìm thấy flashcard
 */
flashcardRouter.delete("/delete/:id", Authentication.AuthenticateToken, FlashcardController.delete);
